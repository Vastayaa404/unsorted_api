...
const dynamicHook = (requester, type, prm) => async (req, res) => { const r = await new Promise(resolve => requester.send({ type, params: { [prm]: req[prm] } }, resolve)); if (r.code > 399) { res.code(200).send(r) }; return r };
